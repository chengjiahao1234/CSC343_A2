...
select Dispatch.driver_id as driver, Pickup.datetime as pickupTime, Dropoff.datetime as dropoffTime, 
...
where to_char(Pickup.datetime, 'YYYY:MM:DD') = to_char(Dropoff.datetime, 'YYYY:MM:DD')
...
where B1.driver = B2.driver and B2.driver = B3.driver and B1.driver = B3.driver 
